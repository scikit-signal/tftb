...
"""
Pseudo Bertrand distribution of Bat sonar
"""
...
tfr, t, f = smoothed_pseudo_wigner(sig.ravel(), K='bertrand', nh0=32, ng0=0,
                                   fmin=0.1, fmax=0.4, n_voices=N)
...
axImage.grid(True)
axImage.set_title("Pseudo Bertrand distribution of bat sonar")

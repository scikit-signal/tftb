...
from tftb.generators.api import gdpower
import numpy as np
from mpl_toolkits.axes_grid1 import make_axes_locatable
import matplotlib.pyplot as plt

sig = gdpower(128, 1.0 / 2)[0]
tfr, t, f = d_flandrin(sig, fmin=0.01, fmax=0.22, n_voices=128)
t, f = np.meshgrid(t, f)

fig, axContour = plt.subplots()
axContour.contour(t, f, tfr)
axContour.grid(True)
axContour.set_title("D-Flandrin distribution of hyperbolic GD signal.")
